...
void main() {
  ...
  setUp(() {
    ...
    dataSource = MovieLocalDataSourceImpl(
        moviesDatabaseHelper: mockMoviesDatabaseHelper);
  });
  ...
  group('save watchlist', () {
    test('should return success message when insert to database is success',
        () async {
      // arrange
      when(mockMoviesDatabaseHelper.insertWatchlist(testMovieTable))
  ...
  group('remove watchlist', () {
    test('should return success message when remove from database is success',
        () async {
      // arrange
      when(mockMoviesDatabaseHelper.removeWatchlist(testMovieTable))
          .thenAnswer((_) async => 1);
      // act
  ...
  group('Get Movie Detail By Id', () {
    ...
    test('should return Movie Detail Table when data is found', () async {
      // arrange
      when(mockMoviesDatabaseHelper.getMovieById(tId))
